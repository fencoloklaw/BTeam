...
?>
<div class="modal fade" id="lenderSignUp" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div id="form-messages"></div>
      <form id="ajax-contact" action="lender-form.php" method="post">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Lender Sign Up</h5>
